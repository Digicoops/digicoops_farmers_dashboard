...
export class AddCustomProductForm implements OnInit {
  ...
  getTypeIcon(type: ProductType): string {
    switch (type) {
      ...
      case ProductType.INPUTS: return '🌱';
      default: return '📦';
    }
  }
  ...
  getPlaceholderExample(): string {
    switch (this.selectedProductType) {
      ...
      case ProductType.INPUTS: return 'Engrais NPK 20-20-20';
      default: return 'Nom du produit';
    }
  }

  getProductNameLabel(): string {
    switch (this.selectedProductType) {
      case ProductType.SERVICE: return 'Nom du service';
      case ProductType.EQUIPMENT: return 'Nom du matériel';
      case ProductType.INPUTS: return 'Nom de l\'intrant';
      default: return 'Nom du produit';
    }
  }
  ...
  getDescriptionPlaceholder(): string {
    switch (this.selectedProductType) {
      ...
      case ProductType.INPUTS:
        return 'Description de l\'intrant (composition, usage, précautions, rendement, etc.)';
      default:
        return 'Description détaillée du produit';
    }
  }

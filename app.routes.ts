...
import { adminCoopGuard } from './core/guard/admin-coop.guard';
...
import { AdminLoginSimpleComponent } from './pages/admin/admin-login/admin-login-simple.component';
...
export const routes: Routes = [
        ...
        children: [
          {
            ...
            title: 'Tableau de bord Administration | DIGICOOP',
            canActivate: [adminGuard]
          },
          {
            path: 'users',
            component: AdminUsersComponent,
            title: 'Gestion des utilisateurs | DIGICOOP',
            canActivate: [adminGuard]
          },
          {
            path: 'orders',
          ...
          },
          {
            ...
            title: 'Paramètres système | DIGICOOP',
            canActivate: [adminGuard]
          }
        ]
      },
  ...
  },
  {
    ...
    title:'Admin Login | DIGICOOP',
  },
  {
    path:'admin-access',
    component:AdminLoginSimpleComponent,
    title:'Admin Access | DIGICOOP',
  },
  {
    path:'admin-register',
    component:AdminRegisterComponent,
    title:'Admin Register | DIGICOOP',
  },
  {
    path:'reset-password',

...
export class UsersManagementComponent implements OnInit {
  ...
  getProfileBadgeClass(profile: string): string {
    ...
    return classes[profile] || 'bg-gray-100 text-gray-800 dark:bg-background-dark/30 dark:text-gray-400';
  }
  ...
  getStatusBadgeClass(status?: string): string {
    ...
    return classes[status || 'active'] || 'bg-gray-100 text-gray-800 dark:bg-background-dark/30 dark:text-gray-400';
  }

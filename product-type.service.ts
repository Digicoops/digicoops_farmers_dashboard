...
export class ProductTypeService {
    ...
    private readonly productTypes: ProductTypeConfig[] = [
        ...
        {
            type: ProductType.INPUTS,
            label: 'Intrants Agricoles',
            description: 'Engrais, semences, produits phytosanitaires et consommables agricoles',
            fields: [
                {
                    name: 'input_category',
                    ...
                    options: [
                        ...
                        { value: 'pesticides', label: 'Produits phytosanitaires' },
                        { value: 'consumables', label: 'Consommables' },
                        { value: 'organic', label: 'Intrants biologiques' },
                        { value: 'growth', label: 'Régulateurs de croissance' },
                        { value: 'soil', label: 'Amendements de sol' }
                    ]
                },
                {
                    name: 'brand',
                    ...
                    type: 'text',
                    required: false,
                    placeholder: 'Ex: Yara, Syngenta, Bayer'
                },
                {
                    name: 'composition',
                    label: 'Composition',
                    type: 'textarea',
                    required: false,
                    placeholder: 'Ex: NPK 20-20-20, matière active, dosage recommandé'
                },
                {
                    name: 'certification',
                    label: 'Certification',
                    ...
                    options: [
                        ...
                        { value: 'bio_certified', label: 'Certifié Bio' },
                ...
                },
                {
                    ...
                    required: false,
                    options: [
                        { value: 'spray', label: 'Pulvérisation' },
                        { value: 'spreading', label: 'Épandage' },
                        { value: 'irrigation', label: 'Via irrigation' },
                ...
                },
                {
                    ...
                    type: 'textarea',
                    required: false,
                    placeholder: 'Précautions d\'emploi, équipement de protection requis'
                },
                {
                    ...
                    type: 'text',
                    required: false,
                    placeholder: 'Ex: Au sec, température ambiante, à l\'abri de la lumière'
                },
                {
                    name: 'shelf_life',
                    ...
                    type: 'text',
                    required: false,
                    placeholder: 'Ex: 2 ans, 12 mois après ouverture'
                }
            ],
            priceUnitOptions: [
                { value: 'kg', label: 'FCFA/kg' },
                { value: 'liter', label: 'FCFA/litre' },
                { value: 'unit', label: 'FCFA/unité' },
                { value: 'bag', label: 'FCFA/sac' },
                { value: 'bottle', label: 'FCFA/bouteille' },
                { value: 'box', label: 'FCFA/boîte' },
                { value: 'hectare', label: 'FCFA/hectare' }
            ]
        }
    ];
